...
import apps.listeners.messagingListeners.groupMessaging.SendScheduledMessageListener;
import apps.listeners.messagingListeners.groupMessaging.WriteNewMessageInGroupListener;
...
public class CreateNewGroupMessagePage extends Page implements Initializable {
    ...
    private FormListener writeScheduledMessageListener;
    private Group group;
    ...
    @FXML
    private TextArea hour;

    @FXML
    private TextArea minute;

    @FXML
    private TextArea second;

    @FXML
    private Button sendScheduled;
    ...
    @FXML
    void sendScheduled(ActionEvent event) {
        ScheduledMessageFormEvent scheduledMessageFormEvent = new ScheduledMessageFormEvent(messageTextArea.getText() , second.getText() , minute.getText() , hour.getText() ,group.getId() , imageFile);
        writeScheduledMessageListener.formRequest(scheduledMessageFormEvent , this);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        this.writeScheduledMessageListener = new SendScheduledMessageListener();
        this.submitButtonListener = new WriteNewMessageInGroupListener();
    }
